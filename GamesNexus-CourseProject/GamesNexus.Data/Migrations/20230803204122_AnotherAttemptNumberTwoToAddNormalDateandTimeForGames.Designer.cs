...
namespace GamesNexus.Data.Migrations
{
    ...
    [Migration("20230803204122_AnotherAttemptNumberTwoToAddNormalDateandTimeForGames")]
    partial class AnotherAttemptNumberTwoToAddNormalDateandTimeForGames
    {
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 41, 22, 224, DateTimeKind.Utc).AddTicks(8040));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Discussion", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 41, 22, 224, DateTimeKind.Utc).AddTicks(8245));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2023, 8, 3, 20, 41, 22, 225, DateTimeKind.Utc).AddTicks(3316),
                        ...
                        new
                        {
                            ...
                            Price = 55.55m,
                            PublisherId = new Guid("dae07e76-9f5d-4bfb-800b-c0dfb0efec5b"),
                            ReleaseDate = new DateTime(2023, 8, 3, 20, 41, 22, 225, DateTimeKind.Utc).AddTicks(3351),
                            SystemRequirementId = 0L,
                            Title = "Spyro"
                        });
                });
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.News", b =>
                {
                    ...
                    b.Property<DateTime>("PublishedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 41, 22, 225, DateTimeKind.Utc).AddTicks(4199));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 41, 22, 225, DateTimeKind.Utc).AddTicks(4391));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 41, 22, 225, DateTimeKind.Utc).AddTicks(5754));
