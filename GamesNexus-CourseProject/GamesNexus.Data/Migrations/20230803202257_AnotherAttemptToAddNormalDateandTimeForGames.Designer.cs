...
namespace GamesNexus.Data.Migrations
{
    ...
    [Migration("20230803202257_AnotherAttemptToAddNormalDateandTimeForGames")]
    partial class AnotherAttemptToAddNormalDateandTimeForGames
    {
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 22, 57, 20, DateTimeKind.Utc).AddTicks(1376));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Discussion", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 22, 57, 20, DateTimeKind.Utc).AddTicks(1546));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Game", b =>
                {
                    ...
                    b.Property<DateTime>("ReleaseDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 22, 57, 20, DateTimeKind.Utc).AddTicks(2483));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.News", b =>
                {
                    ...
                    b.Property<DateTime>("PublishedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 22, 57, 20, DateTimeKind.Utc).AddTicks(7249));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 22, 57, 20, DateTimeKind.Utc).AddTicks(7401));
            ...
            modelBuilder.Entity("GamesNexus.Data.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 3, 20, 22, 57, 20, DateTimeKind.Utc).AddTicks(8730));
