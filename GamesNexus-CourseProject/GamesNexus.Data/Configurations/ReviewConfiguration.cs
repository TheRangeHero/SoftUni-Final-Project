    ...
    public class ReviewConfiguration : IEntityTypeConfiguration<Review>
    {
        ...
        private Review[] GenerateReviews()
        {
            ...
            review = new Review()
            {
                ...
                ApplicationUserId = Guid.Parse("19659AED-ED83-474B-9CB7-13E6140B8C3A"),
                GameId = 1
            };
            reviews.Add(review);
            ...
            review = new Review()
            {
                ...
                ApplicationUserId = Guid.Parse("43BA6E1E-95B7-4F93-8324-A1F0300412D5"),
                GameId = 1
            };
            reviews.Add(review);
            ...
            review = new Review()
            {
                ...
                ApplicationUserId = Guid.Parse("B33DCF98-79E3-4AEA-BB2B-923601190998"),
                GameId = 3
            };
            reviews.Add(review);
